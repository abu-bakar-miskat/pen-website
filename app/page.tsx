...
import { ArrowRight, Globe2, GraduationCap, Lightbulb, TrendingUp, Sparkles, Award, Network } from "lucide-react"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
            ...
            >
              ...
              <p className="text-lg md:text-xl lg:text-xl text-gray-800 leading-relaxed max-w-2xl">
                PEN Group is shaping the future of international education by partnering with universities and industry
                leaders to deliver scalable, high-quality learning opportunities around the world.
              </p>
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          <AnimatedSection className="text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-white/95 leading-relaxed max-w-5xl mx-auto text-pretty">
              PEN Group brings together a diverse network of institutions, services and platforms that collectively
              support learners, partners and communities across multiple regions. This ecosystem enables seamless
              collaboration, operational excellence and meaningful educational impact. This integrated model allows us
              to deliver end-to-end solutions for learners, institutions, governments and corporate partners, ensuring
              that education remains accessible, innovative and impact-driven.
            </p>
          </AnimatedSection>
            ...
            {[
              ...
              >
                ...
                >
                  ...
                  <h3 className={`text-2xl font-bold mb-4 md:mb-5 ${item.textColor}`}>{item.title}</h3>
                  <p
        ...
        <div className="container max-w-7xl mx-auto px-4 md:px-6 space-y-16 relative z-10">
          ...
          <AnimatedSection className="text-center space-y-6 lg:space-y-8">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-800 leading-relaxed max-w-5xl mx-auto text-pretty">
              PEN Group partners with institutions, governments and organisations seeking responsible, future-focused
              and high-performing education solutions. Our experience, values and integrated ecosystem make us a trusted
              collaborator in a rapidly evolving global landscape.
            </p>
          </AnimatedSection>
            ...
            {[
              ...
              >
                ...
                >
                  ...
                  <h3 className={`text-2xl md:text-3xl font-black mb-4 md:mb-5 ${item.textColor}`}>{item.title}</h3>
                  <p
